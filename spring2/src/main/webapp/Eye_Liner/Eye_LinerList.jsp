...
<div class="container w-75 mt-5 mx-auto">
			<hr>
			<ul class="list-group">
				<c:forEach var="eye_liner" items="${eye_linerlist}" varStatus="status">
					<li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"><a href="eye_liner.nhn?action=getEye_Liner&cosmetic_id=${eye_liner.cosmetic_id}" class="text-decoration-none">[${status.count}] ${eye_liner.cosmetic_name}</a>
					</li>
				</c:forEach> 
			</ul>
			<hr>
